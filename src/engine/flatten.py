...
# Vendored from: earthtojake/text-to-cad packages/cadgen/src/cadgen/flatten.py
# Version: cadgen 0.5.1 snapshot, MIT License (https://github.com/earthtojake/text-to-cad)
# 改动: cadgen.build123d lazy proxy → 直接 import build123d
# 边界: 平面精确提取(选面→放平→融合→kerf), 非K因子折弯展开; 折弯件需逐法兰调用
