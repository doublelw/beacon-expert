# Vendored from: earthtojake/text-to-cad packages/cadgen/src/cadgen/drawing_checks.py
# Version: cadgen 0.5.1 snapshot, MIT License (https://github.com/earthtojake/text-to-cad)
# 用法: validate_dxf_file(path) -> [DrawingFinding(severity, code, message)]
# 集成: pipeline.py Stage 5b, 非致命, 结果并入 results["dxf_checks"]
